  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900">
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-in zoom-in duration-500">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2.5rem] shadow-2xl overflow-hidden">
          <div className="px-8 pt-10 pb-6 text-center">
            ...
            <p className="text-slate-300 text-sm">
              Access your precision agriculture dashboard.
            </p>
          </div>
          ...
          <div className="flex px-8 gap-4 mb-6">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${role === "farmer" ? "bg-emerald-500 text-white border-emerald-400 shadow-lg shadow-emerald-500/25" : "bg-white/5 text-slate-400 border-white/10 hover:bg-white/10"}`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${role === "admin" ? "bg-blue-500 text-white border-blue-400 shadow-lg shadow-blue-500/25" : "bg-white/5 text-slate-400 border-white/10 hover:bg-white/10"}`}
            >
          ...
          <div className="px-8 pb-10 bg-white rounded-t-[2.5rem] pt-10">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-3.5 pl-12 pr-4 font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-3.5 pl-12 pr-12 font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-4 rounded-2xl font-bold text-lg text-white shadow-xl flex items-center justify-center gap-2 transition-all transform active:scale-95 ${role === "admin" ? "bg-blue-600 hover:bg-blue-700 shadow-blue-200" : "bg-emerald-600 hover:bg-emerald-700 shadow-emerald-200"} ${isLoading ? "opacity-80 cursor-not-allowed" : ""}`}
              >
                {isLoading ? (
                  <>
        ...
        <p className="text-center text-white/40 text-xs mt-8 font-medium tracking-widest uppercase">
          Secured by SmartPolytunnel Systems
        </p>
      </div>
    </div>
  );
